---
title: "Predicting Credit Scores Using Machine Learning"
author: "Group 2"
format:
  revealjs:
...
## Data Overview
 - ~100,000 records from Kaggle
 - Contains financial, demographic features
 - Target: Credit_Score with 3 classes (Poor, Standard, Good)
 - Split: train.csv, test.csv, score.csv for predictions

## Data Challenges
 - Invalid entries: negative ages, nonsense SSN values (e.g., #F%$D@ in SSN).
 - Missing values in salary and credit history age.
 - Imabalanced target classes (Standard >> Poor/Good) 
...
- PCA reduces 15+ variables to 2 components  
- Helps visualize hidden structure in data
- Shows how customer cluster by credit score
