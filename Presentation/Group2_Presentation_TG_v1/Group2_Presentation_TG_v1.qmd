...
- Combines outputs via **majority vote** (classification)

### Strengths
- Reduces overfitting by averaging multiple trees  
- Robust to noise and handles missing values  
- Performs well on imbalanced data using class weights or sampling

### Why We Used It
- Strong baseline performance  
- Outperformed logistic regression  
- Balanced accuracy, F1-score, and interpretability

## Boosted Trees: XGBoost

- Trains models sequentially, where each tree **corrects errors** of the previous ones  
- Combines many **weak learners** into a strong predictive model  
- Highly efficient and scalable for large datasets

### Why We Chose It
- Delivered the **highest F1 Score (~0.71)** and **Recall** among all models  
- Effectively handled **class imbalance** and noisy features  
- Most robust and accurate for deployment in real-world credit prediction
